"""
    pygments.lexers.move
    ~~~~~~~~~~~~~~~~~~~~

    Lexers for the Move language.
...
class MoveLexer(RegexLexer):
    """
    Lexer for the Move programming language (version 1.47).
    """
    name = 'Move'
    url = 'https://www.move-lang.org/'
    filenames = ['*.move', '*.mv']
    aliases = ['move', 'mv']
    mimetypes = ['text/move', 'text/x-move']
    version_added = '1.6'
    ...
    tokens = {
        'root': [
            # move allows a file to start with a shebang, but if the first line
        ...
        'base': [
            ...
            (words(('as', 'async', 'await', 'box', 'const', 'crate', 'dyn',
                    ...
                    'match', 'move', 'mut', 'pub', 'public', 'inline','ref', 'return', 'static',
            ...
            # Prelude (taken from Move's src/libstd/prelude.rs)
            builtin_funcs_types,
            builtin_macros,
            ...
            # Misc
            # Lone hashes: not used in Move syntax, but allowed in macro
